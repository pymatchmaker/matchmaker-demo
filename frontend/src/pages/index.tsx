...
const IndexPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col font-sans">
      <Head>
        <title>LISzT | Live Score Tracker in your browser</title>
      </Head>

      {/* Nav */}
      <nav className="flex items-center justify-between px-8 py-5 relative z-10">
        <span onClick={() => router.push('/').then(() => router.reload())} className="font-serif text-xl font-semibold tracking-wide text-stone-700 hover:text-stone-900 transition-colors cursor-pointer active:scale-95">LISzT</span>
        <a
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 -mt-16">
        <div className="text-center mb-12">
          <h1 className="font-serif text-5xl font-semibold tracking-tight text-stone-800">
            LISzT <span className="text-stone-400">|</span> Live Score Tracker <span className="text-stone-400 inline-block whitespace-nowrap">in your browser</span>
          </h1>
          <p className="font-serif text-base text-stone-400 mt-2">
            powered by <a href="https://github.com/pymatchmaker/matchmaker" target="_blank" rel="noopener noreferrer" className="text-stone-500 hover:text-stone-700 underline underline-offset-4 decoration-stone-300">Matchmaker</a>
          </p>
        </div>
